...
const CyclesContextProvider = ({ children }: CyclesContextProviderProps) => {
  ...
  useEffect(() => {
    ...
    localStorage.setItem('@timers:cycles-state-1.0.0', stateJSON)
  }, [cyclesState])
  ...
  const createNewCycle = (data: CreateNewCycleFormData) => {
